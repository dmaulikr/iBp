...
static NSString * const LanguageCodes[] = { @"en", @"hi", @"gu", @"mr", @"ta", @"ml", @"es", @"ar", @"fr", @"zh"};
static NSString * const LanguageStrings[] = { @"English", @"Hindi", @"Gujarati", @"Marathi", @"Tamil", @"Malyalam", @"Spanish", @"Arabic", @"French", @"Chinese"};
...
{
     //   NSString *code = LanguageCodes[index];
        [[NSUserDefaults standardUserDefaults] setObject:ID forKey:LanguageSaveKey];
        [[NSUserDefaults standardUserDefaults] synchronize];
        
#ifdef USE_ON_FLY_LOCALIZATION
        [NSBundle setLanguage:ID];
#endif
}
